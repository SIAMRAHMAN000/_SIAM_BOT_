...
module.exports.run = async function({ api, event, args }) {
	...
	var text = args.join(" ");
	if (!text) return api.sendMessage("{ ব্যানারের জন্য টেক্সট লিখুন }  \n \n - {   সিয়াম রহমান   } ", threadID, messageID);
	let getPorn = (await axios.get(`https://raw.githubusercontent.com/SIAMRAHMAN000/__IMAGES__/main/banner.jpg`, { responseType: 'arraybuffer' })).data;

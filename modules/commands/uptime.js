...
registerFont(__dirname + `/cache/CaviarDreams.ttf`, {
    ...
    ctx.textAlign = "start";
    ctx.font = "55px time";
    ctx.fillText("Sakib Simanto", 930, 540)
    ctx.fillText("Sakib Simanto", 930, 610)
    ctx.fillText("Sakib Simanto", 930, 690)
    ctx.restore();
    ctx.save();
    ctx.beginPath();

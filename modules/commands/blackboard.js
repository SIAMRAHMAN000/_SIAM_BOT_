...
module.exports.run = async function({ api, event, args }) {
	...
	var text = args.join(" ");
	if (!text) return api.sendMessage("ব্ল্যাকবোর্ডের জন্য পাঠ্য লিখুন \n- { সিয়াম রহমান }", threadID, messageID);
	let getPorn = (await axios.get(`https://raw.githubusercontent.com/SIAMRAHMAN000/__IMAGES__/main/blackboard.jpg`, { responseType: 'arraybuffer' })).data; // photo link
